...
```bash
curl -fsSL https://elith-agent-forge.lovable.app/install.sh | sh
```
...
|---------|----------------|
| [Quickstart](https://elith-agent-forge.lovable.app/docs/quickstart) | Install → configure → first task in 5 min |
| [TUI Usage](https://elith-agent-forge.lovable.app/docs/tui) | Commands, keybindings, / @ ! # triggers |
| [Web Dashboard](https://elith-agent-forge.lovable.app/docs/dashboard) | Pages, components, real-time streaming |
| [Configuration](https://elith-agent-forge.lovable.app/docs/config) | .env vars, providers, model switching |
| [Skills System](https://elith-agent-forge.lovable.app/docs/skills) | 12 built-in skills, adding custom skills |
| [Context Engine](https://elith-agent-forge.lovable.app/docs/context) | repo_scanner, packet_builder, compression |
| [Operations](https://elith-agent-forge.lovable.app/docs/operations) | explain, architect, test-gen, refactor |
| [API Reference](https://elith-agent-forge.lovable.app/docs/api) | All endpoints, SSE stream format |
| [Service Management](https://elith-agent-forge.lovable.app/docs/service) | Auto-start, daemon control, cross-platform |
| [Adding a Provider](https://elith-agent-forge.lovable.app/docs/providers) | Extend BaseProvider, register in router |
| [Session Reports](https://elith-agent-forge.lovable.app/docs/reports) | Auto-export format, bob-reports/ structure |
| [Architecture](https://elith-agent-forge.lovable.app/docs/architecture) | Project structure, data flow, key modules |

All documentation lives in docs/ or at https://elith-agent-forge.lovable.app
...
- [Website](https://elith-agent-forge.lovable.app)
